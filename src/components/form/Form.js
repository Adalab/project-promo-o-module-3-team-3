			...
			<fieldset className="form__design">
				...
				<div className="form__design--wrapper">
					...
					<div className="form__input--wrapper">
						<Palette handleInput={props.handleInput} data={props.data} paletteColor="1" />
						<Palette handleInput={props.handleInput} data={props.data} paletteColor="2" />
						<Palette handleInput={props.handleInput} data={props.data} paletteColor="3" />
					</div>
				</div>
			</fieldset>
