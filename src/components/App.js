			...
			<section className="card__wrapper">
				<section className="section__cards">
					<div className="card__preview">
						<button className="preview__reset js-reset" type="reset">
							<p className="preview__reset--text">Reset</p>
							<i className="far fa-trash-alt preview__reset--icon" />
						</button>
						<div className="card__preview--default">
							<div className="preview__text js-borderleft">
								<h3 className="preview__text--name js-preview-name">Nombre Apellido</h3>
								<h4 className="preview__text--role js-preview-job">Front-End Developer</h4>
							</div>
							...
							<div className="preview__links">
								<a
									...
									target="_self"
								>
									<i className="fas fa-mobile-alt preview__links--icon js-icons" />
								</a>
								<a
									href="#"
									...
									target="_self"
								>
									<i className="far fa-envelope preview__links--icon js-icons" />
								</a>
								<a
									href="#"
									...
									target="_self"
								>
									<i className="fab fa-linkedin-in preview__links--icon js-icons" />
								</a>
								<a
									href="#"
									...
									target="_self"
								>
									<i className="fab fa-github-alt preview__links--icon js-icons" />
								</a>
							</div>
						</div>
					</div>
				...
				<form action="#" method="get" className="form js-form">
					<fieldset className="form__design">
						<legend className="form__title js-design__title">
							<ul>
								<i className="form__title--icon icon-light far fa-object-ungroup" />
							</ul>
							<h2 className="form__title--text">Diseña</h2>
							<ul>
								<i className="form__title--chevron icon-medium far fa-chevron-up" />
							</ul>
						</legend>
						<div className="form__design--wrapper">
							<label htmlFor="chooseColor" className="form__label form__label--color">
								Colores
							</label>
					...
					<fieldset className="form__fill collapsed">
						<legend className="form__title js-fill__title">
							<i className="form__title--icon far fa-keyboard" />
							<h2 className="form__title--text">Rellena</h2>
							<i className="form__title--chevron icon-medium far fa-chevron-down" />
						</legend>
						<div className="form__fill--wrapper">
							...
							<div className="form__photosection">
								<label htmlFor="photo" className="form__photobutton js__profile-trigger">
									Añadir imagen
								</label>
								<input
					...
					<fieldset className="form__share collapsed">
						<legend className="form__title js-share__title">
							<i className="form__title--icon fas fa-share-alt" />
						...
						<div className="form__share--wrapper">
							<button className="form__submit js-submit" type="submit" disabled>
								<i className="form__submit--icon far fa-address-card" />
								crear tarjeta
							</button>
			...
			<footer className="footer">
				<div className="footer__container">
					<section className="footer__copy">
						u<span className="required">·</span>n<span className="required">·</span>d
						<span className="required">·</span>e<span className="required">·</span>f
						<span className="required">·</span>i<span className="required">·</span>n
						<span className="required">·</span>e<span className="required">·</span>d &copy;
						2021
					</section>
				</div>
