		...
		<section className="section__cards">
			<div className="card__preview">
				...
				<div className="card__preview--default">
					<div className={`preview__text js-borderleft border-text${props.data.palette}`}>
						<h3 className={`preview__text--name js-preview-name text${props.data.palette}`}>
					...
					<div className="preview__links">
						...
						<a
							href={
								props.data.linkedin ? `https://www.linkedin.com/in/${props.data.linkedin}` : "#"
							}
							className={`preview__links--social js-preview-linkedin js-border border-icon${props.data.palette}`}
							title={props.data.linkedin ? `Linkedin: ${props.data.linkedin}` : `Linkedin`}
							target="_blank"
							rel="noreferrer"
						>
							<i
						...
						<a
							href={props.data.github ? `https://github.com/${props.data.github}` : "#"}
							className={`preview__links--social js-preview-github js-border border-icon${props.data.palette}`}
							title={props.data.github ? `Github: ${props.data.github}` : `Github`}
							target="_blank"
							rel="noreferrer"
						>
							<i
